...
echo ""
echo "How it works:"
echo "  Step 1: Automatically tests all IPs for latency"
echo "  Step 2: Asks you how many IPs to speed test"
echo "          (you enter a number, e.g. 100 or 500)"
echo ""
echo "Tips:"
echo "  - Press Ctrl+C at any time to stop and see"
echo "    results found so far"
echo "  - Results are saved to: clean_ips.txt"
echo ""
echo "Files location:"
