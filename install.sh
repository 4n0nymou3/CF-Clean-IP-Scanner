...
echo ""
echo "How it works:"
echo "  Step 1: Tests all IPs with 4 TCP pings each"
echo "          (calculates loss rate + average latency)"
echo "  Step 2: Asks how many IPs to download speed test"
echo "          (uses speed.cloudflare.com for accuracy)"
echo ""
echo "Tips:"
echo "  - Press Ctrl+C anytime to stop and see results so far"
